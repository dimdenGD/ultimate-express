...
[`npm install ultimate-express`](https://npmjs.com/package/ultimate-express) > replace `express` with `ultimate-express` > done[(?)](https://github.com/dimdenGD/ultimate-express?tab=readme-ov-file#differences-from-express)  
