...
describe('res', function(){
  describe('.download(path)', function(){
    it('should transfer as an attachment', function(done){
      ...
      app.use(function(req, res){
        res.download('tests/express-tests/test/fixtures/user.html');
      });
  ...
  describe('.download(path, filename)', function(){
    it('should provide an alternate filename', function(done){
      ...
      app.use(function(req, res){
        res.download('tests/express-tests/test/fixtures/user.html', 'document');
      });
  ...
  describe('.download(path, fn)', function(){
    it('should invoke the callback', function(done){
      ...
      app.use(function(req, res){
        res.download('tests/express-tests/test/fixtures/user.html', cb);
      });
    ...
    describeAsyncHooks('async local storage', function () {
      it('should presist store', function (done) {
        ...
        app.use(function (req, res) {
          res.download('tests/express-tests/test/fixtures/name.txt', function (err) {
      ...
      it('should presist store on error', function (done) {
        ...
        app.use(function (req, res) {
          res.download('tests/express-tests/test/fixtures/does-not-exist', function (err) {
            var local = req.asyncLocalStorage.getStore()
  ...
  describe('.download(path, options)', function () {
    it('should allow options to res.sendFile()', function (done) {
      ...
      app.use(function (req, res) {
        res.download('tests/express-tests/test/fixtures/.name', {
          dotfiles: 'allow',
          maxAge: '4h'
        })
      })
    ...
    describe('with "headers" option', function () {
      ...
      it('should not set headers on 404', function (done) {
        ...
        app.use(function (req, res) {
          res.download('tests/express-tests/test/fixtures/does-not-exist', {
            headers: {
              'X-Foo': 'Bar'
            }
          })
  ...
  describe('.download(path, filename, fn)', function(){
    it('should invoke the callback', function(done){
      ...
      app.use(function(req, res){
        res.download('tests/express-tests/test/fixtures/user.html', 'document', cb)
      });
  ...
  describe('.download(path, filename, options, fn)', function () {
    it('should invoke the callback', function (done) {
      ...
      app.use(function (req, res) {
        res.download('tests/express-tests/test/fixtures/user.html', 'document', options, cb)
      })
    ...
    it('should allow options to res.sendFile()', function (done) {
      ...
      app.use(function (req, res) {
        res.download('tests/express-tests/test/fixtures/.name', 'document', {
          dotfiles: 'allow',
          maxAge: '4h'
        })
      })
  ...
  describe('on failure', function(){
    it('should invoke the callback', function(done){
      ...
      app.use(function (req, res, next) {
        res.download('tests/express-tests/test/fixtures/foobar.html', function(err){
