...
describe('res', function(){
  ...
  describe('.sendfile(path, fn)', function(){
    it('should invoke the callback when complete', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/user.html', cb)
      });
    ...
    it('should utilize the same options as express.static()', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/user.html', { maxAge: 60000 });
      });
    ...
    it('should invoke the callback when client aborts', function (done) {
      ...
      app.use(function (req, res) {
        setImmediate(function () {
          res.sendfile('tests/express-tests/test/fixtures/name.txt', function (err) {
            assert.ok(err)
            assert.strictEqual(err.code, 'ECONNABORTED')
            cb()
          });
    ...
    it('should invoke the callback without error when HEAD', function (done) {
      ...
      app.use(function (req, res) {
        res.sendfile('tests/express-tests/test/fixtures/name.txt', cb);
      });
    ...
    it('should invoke the callback on 404', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/nope.html', function(err){
    ...
    it('should not override manual content-types', function(done){
      ...
      app.use(function(req, res){
        res.contentType('txt');
        res.sendfile('tests/express-tests/test/fixtures/user.html');
      });
    ...
    it('should invoke the callback on 403', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/foo/../user.html', function(err){
          assert(!res.headersSent);
          res.send(err.message);
        });
      });
    ...
    it('should invoke the callback on socket error', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/user.html', function(err){
          assert.ok(err)
    ...
    describeAsyncHooks('async local storage', function () {
      ...
      it('should presist store on error', function (done) {
        ...
        app.use(function (req, res) {
          res.sendfile('tests/express-tests/test/fixtures/does-not-exist', function (err) {
            var local = req.asyncLocalStorage.getStore()
  ...
  describe('.sendfile(path)', function(){
    it('should not serve dotfiles', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/.name');
      });
    ...
    it('should accept dotfiles option', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/.name', { dotfiles: 'allow' });
      });
    ...
    it('should accept headers option', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/user.html', { headers: headers });
      });
    ...
    it('should ignore headers option on 404', function(done){
      ...
      app.use(function(req, res){
        res.sendfile('tests/express-tests/test/fixtures/user.nothing', { headers: headers });
      });
    ...
    it('should transfer a file', function (done) {
      ...
      app.use(function (req, res) {
        res.sendfile('tests/express-tests/test/fixtures/name.txt');
      });
    ...
    it('should transfer a directory index file', function (done) {
      ...
      app.use(function (req, res) {
        res.sendfile('tests/express-tests/test/fixtures/blog/');
      });
    ...
    it('should transfer a file with urlencoded name', function (done) {
      ...
      app.use(function (req, res) {
        res.sendfile('tests/express-tests/test/fixtures/%25%20of%20dogs.txt');
      });
    ...
    describe('with a relative path', function(){
      ...
      it('should serve relative to "root"', function(done){
        ...
        app.use(function(req, res){
          res.sendfile('user.html', { root: 'tests/express-tests/test/fixtures/' });
        });
      ...
      it('should consider ../ malicious when "root" is not set', function(done){
        ...
        app.use(function(req, res){
          res.sendfile('tests/express-tests/test/fixtures/foo/../user.html');
        });
      ...
      it('should allow ../ when "root" is set', function(done){
        ...
        app.use(function(req, res){
          res.sendfile('foo/../user.html', { root: 'tests/express-tests/test/fixtures' });
        });
